...
" Modified my Keith Prussing to get some settings right for my taste.
" 17 February 2013.
...
" 130217: I almost always use free form so use that unless we have a 
" blatant F77 file.
let s:extname = expand("%:e")
if s:extname ==? "F77"
...
if (b:fortran_fixed_source == 1)
  ...
  " 130217
  "setlocal tw=80
  " I still want my 72 characters so shut it. I know it's old-school,
...
" 130217: Add 2003 and 2008
setlocal suffixesadd+=.f03,.f08,.F03,.F08,.F95,.F90
